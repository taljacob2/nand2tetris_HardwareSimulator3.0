...
public class CallStackComponent extends JPanel implements CallStackGUI {
    ...
    public CallStackComponent() {
        ...
        callStackTable.setRowHeight(ResolutionUtils.getInstance().ROW_HEIGHT);

        //TODO: My addition: customize FONT AND COLOR of table header:
        JTableHeader header = callStackTable.getTableHeader();
    ...
    public int getTableWidth() {
        return (int) (190 * ResolutionUtils.getInstance().RESOLUTION_SCALE_PARAMETER);
    ...
    public class callStackTableCellRenderer extends DefaultTableCellRenderer {
        ...
        public void setRenderer(int row, int column) {
            if (row == (methodNames.size() - 1))
                setForeground(Colors.getInstance().markedDigits);//TODO: check
        }
    }
}
