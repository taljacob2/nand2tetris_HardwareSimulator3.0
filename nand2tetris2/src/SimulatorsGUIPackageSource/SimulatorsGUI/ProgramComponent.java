...
public class ProgramComponent extends JPanel implements VMProgramGUI {
    ...
    public ProgramComponent() {
        ...
        programTable.setRowHeight(ResolutionUtils.getInstance().ROW_HEIGHT);
    ...
    private void jbInit() {
        ...
        messageTxt.setBackground(SystemColor.info);//TODO: DOESN'T DO ANYTHING
    ...
    class ColoredTableCellRenderer extends DefaultTableCellRenderer {
        ...
        public Component getTableCellRendererComponent
            ...
            if (row == instructionIndex)
                setBackground(Color.yellow);//TODO: DOESN'T DO ANYTHING
            else {
