...
import static HackGUI.Utilities.boldValueFont;
...
public class PinsComponent extends JPanel implements PinsGUI, MouseListener, PinValueListener {
    ...
    public PinsComponent() {
        ...
        pinsTable.setRowHeight(ResolutionUtils.getInstance().ROW_HEIGHT);
        //TODO: My addition: customize FONT AND COLOR of table header:
        JTableHeader header = pinsTable.getTableHeader();
    ...
    //TODO: important?! - THIS SETS THE COLUMN TABLE'S SIZE!?
    ...
    public void setVisibleRows(int num) {
        int tableHeight = num * pinsTable.getRowHeight(); //TODO: I think it's the Table of the pins on the top: named as "Input pins"
    ...
    public int getTableWidth() {
        return (int) (241 * ResolutionUtils.getInstance().RESOLUTION_SCALE_PARAMETER * ResolutionUtils.getInstance().RESOLUTION_SCALE_PARAMETER);//TODO : TABLE WIDTH of 'Input/Output pins' !!! WORKS!!!
    }
    ...
    private void jbInit() {
        ...
        binary.setSize(new Dimension((int) (240 * ResolutionUtils.getInstance().RESOLUTION_SCALE_PARAMETER), (int) (52 * ResolutionUtils.getInstance().RESOLUTION_SCALE_PARAMETER)));//TODO: CHANGES BINARY INPUT SMALL WINDOW
        binary.setLayout(null);
        binary.setVisible(false);
        binary.addListener(this);
        determineColumnWidth();
        nameLbl.setText("Name :");
        nameLbl.setBounds(new Rectangle(0, 0, getTableWidth(), ResolutionUtils.getInstance().ROW_HEIGHT));//TODO in order to Center, must set width to Table's width
        ...
        //TODO: SET COLOR OF LABELS: 'Input pins' and 'Output pins' and 'Internal pins' and 'Part pins' Tables:
    ...
    //TODO: SETS THE COLORS OF THE 'Input pins' TABLE  & 'Output pins' TABLE!!!
    ...
    class PinsTableCellRenderer extends DefaultTableCellRenderer {
        ...
        public Component getTableCellRendererComponent
            ...
            if (column == 0) {
                ...
                setForeground(Colors.getInstance().inputOutputPinsTables_TextForeground);//TODO: Sets the color of the Tables Text FOREGROUND
                setBackground(Colors.getInstance().inputOutputPinsTables_Name_ColumnBackgroundRow);//TODO: Sets the color of 'Name' columns BACKGROUND in both TABLES
            }
            else {
                setHorizontalAlignment(SwingConstants.RIGHT);
                for (int i = 0; i < highlightIndex.size(); i++) {
                    if (row == ((Integer) highlightIndex.elementAt(i)).intValue()) {
                        setForeground(Colors.getInstance().markedDigits);/*TODO: sets the color of a pin after change.*/
                        break;
                    }
                    else
                        setForeground(null);
                ...
                if (row == flashIndex) {
                    ...
                    setBackground(Colors.getInstance().inputOutputPinsTables_Value_ColumnBackgroundRow);//TODO: Sets the color of the 'Value' column BACKGROUND
