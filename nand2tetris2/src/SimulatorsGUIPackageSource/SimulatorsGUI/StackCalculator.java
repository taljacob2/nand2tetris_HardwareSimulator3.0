...
public class StackCalculator extends JPanel implements CalculatorGUI {
    ...
    public void highlight(int index) {
        switch (index) {
            case 0:
                firstInput.setForeground(Colors.getInstance().markedDigits);
                break;
            case 1:
                secondInput.setForeground(Colors.getInstance().markedDigits);
                break;
            case 2:
                output.setForeground(Colors.getInstance().markedDigits);
                break;
        }
    }
