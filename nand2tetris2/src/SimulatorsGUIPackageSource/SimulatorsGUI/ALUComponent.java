...
public class ALUComponent extends JPanel implements ALUGUI {
    ...
    public void hideFlash() {
        location0.setBackground(Colors.getInstance().hideFlash);
        location1.setBackground(Colors.getInstance().hideFlash);
        location2.setBackground(Colors.getInstance().hideFlash);
    }
    ...
    public void hideHighlight() {
        location0.setDisabledTextColor(Colors.getInstance().disabledTextForeground);
        location1.setDisabledTextColor(Colors.getInstance().disabledTextForeground);
        location2.setDisabledTextColor(Colors.getInstance().disabledTextForeground);
        repaint();
    }
    ...
    public void highlight(int index) {
        ...
        switch (index) {
            case 0:
                location0.setDisabledTextColor(Colors.getInstance().markedDigits);
                break;
            case 1:
                location1.setDisabledTextColor(Colors.getInstance().markedDigits);
                break;
            case 2:
                location2.setDisabledTextColor(Colors.getInstance().markedDigits);
                break;
        }
        repaint();
    }
    ...
    private void jbInit() {
        ...
        commandLbl.setDisabledTextColor(Colors.getInstance().disabledTextForeground);
