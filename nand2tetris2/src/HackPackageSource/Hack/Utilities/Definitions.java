...
public class Definitions {
    ...
    // screen size
    private static final int SCREEN_WIDTH_IN_WORDS = (int) (32 * ResolutionUtils.getInstance().RESOLUTION_SCALE_PARAMETER);//TODO : DOESN'T DO ANYTHING
    private static final int SCREEN_HEIGHT_IN_WORDS = (int) (256 * ResolutionUtils.getInstance().RESOLUTION_SCALE_PARAMETER);//TODO : DOESN'T DO ANYTHING
