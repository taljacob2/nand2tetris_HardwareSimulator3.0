...
//TODO: THIS WHOLE CLASS REPRESENTS THE 'HDL' TEXT FIELD
public class TextFileComponent extends JPanel implements TextFileGUI {
    ...
    public TextFileComponent() {
        ...
        textFileTable = new WideTable(model, 1000);//TODO: DOESN'T DO ANYTHING
        ...
        //! TODO: ! FORCE SET EACH ROW HEIGHT SIZE IN THE HDL TABLE::
        textFileTable.setRowHeight(ResolutionUtils.getInstance().ROW_HEIGHT);
    ...
    public void setVisibleRows(int num) {
        int tableHeight = (int) (num * textFileTable.getRowHeight() * ResolutionUtils.getInstance().RESOLUTION_SCALE_PARAMETER);// TODO: SETS 'HDL' TEXT HEIGHT !!!!!!
        scrollPane.setSize(getTableWidth(), tableHeight + 3);
        setPreferredSize(new Dimension(getTableWidth(), tableHeight + 30));//TODO: DOESN'T DO ANYTHING
        setSize(getTableWidth(), tableHeight + 30);//TODO: DOESN'T DO ANYTHING
        textFileTable.getParent().setSize(new Dimension(1000, tableHeight));//TODO: DOESN'T DO ANYTHING
    }

    /**
     * Returns the width of the table.
     */
    public int getTableWidth() {//TODO: WIDTH OF 'HDL' TABLE !
        return (int) (241 * ResolutionUtils.getInstance().RESOLUTION_SCALE_PARAMETER * ResolutionUtils.getInstance().RESOLUTION_SCALE_PARAMETER);
    }
    /* TODO:
        sets WIDTH of 'HDL' text field !!!
        (also, note that I chose here to double the Width once more for comforting the user)
    */
    ...
    private void jbInit() {
        ...
        //TODO: I guess this is the 'HDL' Table

        scrollPane = new JScrollPane(textFileTable);//TODO: probably means: 'HDL' Text field
        scrollPane.setLocation(0, 27); //TODO: SETS HORIZONTAL SCROLL BAR LOCATION OF THE 'HDL' TEXT FIELD!
        scrollPane.setHorizontalScrollBarPolicy(JScrollPane.HORIZONTAL_SCROLLBAR_ALWAYS);
        scrollPane.getHorizontalScrollBar().setUnitIncrement(scrollPane.getHorizontalScrollBar().getBlockIncrement());

        nameLbl.setBounds(new Rectangle(0, 0, getTableWidth(), ResolutionUtils.getInstance().ROW_HEIGHT)); //TODO: sets the 'HDL' Title to be centered by setting width here to getTableWidth()
        nameLbl.setFont(Utilities.labelsFont);

        //TODO: center LABEL !:
        nameLbl.setHorizontalAlignment(SwingConstants.CENTER);
        //TODO: SET COLOR OF LABEL :
    ...
    public class TextFileCellRenderer extends DefaultTableCellRenderer {
        ...
        public Component getTableCellRendererComponent
            ...
            setForeground(null);//TODO: DOESN'T DO ANYTHING
        ...
        public void setRenderer(int row, int column) {
            if (highlightedLines.contains(new Integer(row)))
                ...
                setBackground(Colors.getInstance().hdlTableBackgroundRow);//TODO: Sets the color of the 'HDL' Table Text BACKGROUND

            if (emphasizedLines.contains(new Integer(row)))
                setForeground(Color.red);
            else
                setForeground(Colors.getInstance().hdlTableTextForeground);//TODO: Sets the color of the 'HDL' Table Text FOREGROUND
        }
    }
}
