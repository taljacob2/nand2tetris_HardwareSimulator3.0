...
public class TitledComboBox extends JPanel {
    ...
    private static final int TOTAL_HEIGHT = (int) (37 * ResolutionUtils.getInstance().RESOLUTION_SCALE_PARAMETER);//TODO: changes the top button menu height such as "Animate", "Format", "View".

    // The height of the combo box only (without the title).
    private static final int COMBO_HEIGHT = (int) (22 * ResolutionUtils.getInstance().RESOLUTION_SCALE_PARAMETER);//TODO: changes the top button menu height such as "Animate", "Format", "View".
    ...
    public TitledComboBox(String titleText, String toolTipText, String[] items, int width) {
        ...
        //TODO: My addition: SET COLOR FOR COMBO "Animate", "Format", "View" :
        title.setForeground(Colors.getInstance().comboAnimateFormatView);
