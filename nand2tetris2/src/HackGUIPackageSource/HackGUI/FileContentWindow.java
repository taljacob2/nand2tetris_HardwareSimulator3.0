...
public class FileContentWindow extends JFrame {
    ...
    private void jbInit() {
        ...
        fileContent.setDisabledTextColor(Colors.getInstance().disabledTextForeground);
        scrollPane = new JScrollPane(fileContent);
        scrollPane.setPreferredSize(new Dimension((int) (190 * ResolutionUtils.getInstance().RESOLUTION_SCALE_PARAMETER), (int) (330 * ResolutionUtils.getInstance().RESOLUTION_SCALE_PARAMETER)));//TODO: DOESN'T DO ANYTHING
        setSize((int) (375 * ResolutionUtils.getInstance().RESOLUTION_SCALE_PARAMETER), (int) (372 * ResolutionUtils.getInstance().RESOLUTION_SCALE_PARAMETER));//TODO: DOESN'T DO ANTYHING
