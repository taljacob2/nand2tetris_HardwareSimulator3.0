...
public class BusComponent extends JPanel implements ActionListener, BusGUI {
    ...
    private static final int HEIGHT = 22;// TODO: DOESN'T DO ANYTHING
    ...
    private void jbInit() {
        ...
        txtField.setBackground(Colors.getInstance().textBackground);
        txtField.setEnabled(false);
        txtField.setBorder(txtBorder);
        txtField.setDisabledTextColor(Colors.getInstance().disabledTextForeground);
