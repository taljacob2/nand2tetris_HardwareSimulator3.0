...
public class RegisterComponent extends JPanel implements RegisterGUI {
    ...
    public void highlight(int index) {
        registerValue.setForeground(Colors.getInstance().markedDigits);
    }
    ...
    public void hideFlash() {
        registerValue.setBackground(Colors.getInstance().hideFlash);
    }
    ...
    private void jbInit() {
        ...
        registerValue.setDisabledTextColor(Colors.getInstance().disabledTextForeground);
