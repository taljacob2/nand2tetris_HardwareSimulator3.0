...
public class MemoryComponent extends JPanel implements MemoryGUI {
    ...
    protected static final int DEFAULT_VISIBLE_ROWS = (int) (10 * ResolutionUtils.getInstance().RESOLUTION_SCALE_PARAMETER); //TODO: DOENS'T DO ANYTHING
    ...
    public MemoryComponent() {
        ...
        memoryTable.setRowHeight(ResolutionUtils.getInstance().ROW_HEIGHT);
        //TODO: My addition: customize FONT AND COLOR of table header:
        JTableHeader header = memoryTable.getTableHeader();
    ...
    public int getTableWidth() {
        return (int) (193 * ResolutionUtils.getInstance().RESOLUTION_SCALE_PARAMETER);
    }//TODO: TABLE WIDTH - DOESN'T DO ANYTHING
    ...
    protected void determineColumnWidth() {
        ...
        for (int i = 0; i < 2; i++) {
            ...
            if (i == 0) {
                column.setPreferredWidth((int) (30 * ResolutionUtils.getInstance().RESOLUTION_SCALE_PARAMETER));//TODO:  - DOESN'T DO ANYTHING
            }
            else {
                column.setPreferredWidth((int) (100 * ResolutionUtils.getInstance().RESOLUTION_SCALE_PARAMETER));//TODO:  - DOESN'T DO ANYTHING
            }
        }
    }
