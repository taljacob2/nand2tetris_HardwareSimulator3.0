...
public class BreakpointWindow extends JFrame implements MouseListener, BreakpointChangedListener {
    ...
    public BreakpointWindow() {
        ...
        breakpointTable.setRowHeight(ResolutionUtils.getInstance().ROW_HEIGHT);
        //TODO: My addition: customize FONT AND COLOR of table header:
        JTableHeader header = breakpointTable.getTableHeader();
